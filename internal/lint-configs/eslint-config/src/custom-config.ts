...
const customConfig: Linter.Config[] = [
          ...
          patterns: [
            {
              group: ['@formulago/*'],
              message:
                'The @core package cannot import the @formulago package, please use the @core package itself',
            },
          ],
        },
      ],
  ...
  {
    // @core/shared内部组件，不能引入@formulago/* 或者 @vben-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@formulago/*', '@vben-core/*'],
              message:
                'The @vben-core/shared package cannot import the @formulago package, please use the @core/shared package itself',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              group: ['@formulago/*'],
              message:
                'The @formulago package cannot be imported, please use the @core package itself',
            },
          ],
        },
      ],
