...
import type { BuiltinThemePreset } from '@formulago/preferences';
import type { BuiltinThemeType } from '@formulago/types';

import { computed, ref, watch } from 'vue';

import { UserRoundPen } from '@formulago/icons';
import { $t } from '@formulago/locales';
import { BUILT_IN_THEME_PRESETS } from '@formulago/preferences';
import { convertToHsl, TinyColor } from '@formulago/utils';
