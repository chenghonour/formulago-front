...
import type { CustomPreferencesRecord } from '@formulago/preferences';
import type {
  BreadcrumbStyleType,
  BuiltinThemeType,
  ContentCompactType,
...
import { Copy, Pin, PinOff, RotateCw } from '@formulago/icons';
import { $t, loadLocaleMessages } from '@formulago/locales';
import {
  clearCache,
  preferences,
  resetPreferences,
