...
import { execa } from '@formulago/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignoreDependencies: [
    '@iconify/json',
    '@vben-core/design',
    '@formulago/commitlint-config',
    '@formulago/eslint-config',
    '@formulago/stylelint-config',
    '@formulago/tailwind-config',
    '@formulago/vite-config',
    '@formulago/oxlint-config',
    'playwright',
    'rimraf',
    'tailwindcss',
  ],
